...
namespace Crowe_HelloWorldService.Tests.Controllers
{
    ...
    {
        [TestMethod]
        public void HelloWorld_ReturnText()
        {
            // Arrange
            HelloWorldController controller = new HelloWorldController(new HelloWorldMessage());

            // Act
            IHttpActionResult result = controller.GetHelloWorldMsg();
